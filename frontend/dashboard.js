...
async function initExtensionDownload() {
    ...
    if (extensionVersion) extensionVersion.textContent = '4.4.11 (E.I.O System)';

    // Download button - Simple direct download
    if (btnDownload) {
        btnDownload.addEventListener('click', () => {
            // Direct navigation to update file
            window.location.href = 'downloads/eio-extension-v4.4.11.zip';
        });
    }
            ...
            <div class="eio-modal-body">
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <p style="color: #aaa; line-height: 1.6;">
                        Após o download, localize o arquivo <code style="background: rgba(255,255,255,0.1); padding: 2px 6px; border-radius: 4px;">eio-extension-v4.4.11.zip</code> 
