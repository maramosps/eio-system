// ═══════════════════════════════════════════════════════════
// v4.4.24 - GLOBAL CONNECTION INTEGRATION
...
async function initExtensionDownload() {
    ...
    // ═══════════════════════════════════════════════════════════
    let currentVersion = '4.7.15'; // Fallback
    try {
        ...
        <div class="eio-modal-content" style="max-width: 750px;">
            ...
            <div class="eio-modal-body">
                ...
                <div style="margin-bottom: 25px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 20px;">
                    <h4 style="color: #ff0055; margin-bottom: 10px;">🔥 Novidades da Versão 4.7.4 (Leitura Obrigatória)</h4>
...
// ═══════════════════════════════════════════════════════════
// v4.4.24 - GERENCIAMENTO DE CONEXÃO REMOVIDO DESTE ARQUIVO
