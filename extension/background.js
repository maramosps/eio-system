...
═══════════════════════════════════════════════════════════
  ...
  Motor de automação ultra-estável - VERSÃO 4.4.20 (SYNC ANALYTICS)
  COM DELAYS INTELIGENTES + HARDCODED SAFETY
  + ACTION LOG MIDDLEWARE + HEARTBEAT + AUTO-FILTERS
═══════════════════════════════════════════════════════════
*/

console.log('E.I.O Extension v4.4.20 starting...');
...
// ═══════════════════════════════════════════════════════════
// v4.4.20 - HELPER FUNCTIONS FOR AUTH
// ═══════════════════════════════════════════════════════════
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    ...
    switch (action) {
        ...
        // ═══════════════════════════════════════════════════════════
        // v4.4.20 - SYNC_AUTH: Recebe Token do Dashboard via Bridge
        // ═══════════════════════════════════════════════════════════
        case 'SYNC_AUTH':
        ...
        // ═══════════════════════════════════════════════════════════
        // v4.4.20 - SAVE_AUTH: Novo formato de mensagem da Bridge
        // ═══════════════════════════════════════════════════════════
        case 'SAVE_AUTH':
        ...
        // ═══════════════════════════════════════════════════════════
        // v4.4.20 - BRIDGE_CONNECTED: Dashboard conectou via Bridge
        // ═══════════════════════════════════════════════════════════
        case 'bridge_connected':
            ...
            sendResponse({ success: true, version: '4.4.20' });
            break;
    }
    return true;
});
...
console.log('E.I.O Extension v4.4.20 Ready - Sync Analytics + Hardcoded Safety Active');
