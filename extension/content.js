...
console.log('E.I.O Content Script v4.7.3 Initializing - RECIPROCITY MODE...');
...
// Inicialização
console.log('E.I.O Content Script v4.7.3 Ready!');
...
console.log('E.I.O Content Script v4.7.3 - Auto popup dismiss enabled!');
